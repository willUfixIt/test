				...
				<ul class="forminfo">
					...
					<li><label for="name">身份证号码<b>*</b></label>
						<div class="vocation">
							...
							<span style="color:red;font-size:12px">${errorMap.idcard==null?'':errorMap.idcard }</span>
						</div></li>
					<br />
					<li><label for="name">手机号码<b>*</b></label>
						<div class="vocation">
							...
							<span style="color:red;font-size:12px">${errorMap.phone==null?'':errorMap.phone }</span>
						</div></li>
					<br />
